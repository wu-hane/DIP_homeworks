...
class DragWidget:
    def __init__(self, viz):
        ...
        # Initialize with custom points and targets if needed
        # self.set_custom_points_and_targets([(100, 100)], [(200, 200)])
    ...
    def set_custom_points_and_targets(self, points, targets):
        self.points = points
